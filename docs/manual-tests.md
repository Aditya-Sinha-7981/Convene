...
| B1a | Hindi and Hinglish | with `language = "auto"`, say five Hindi sentences and five natural Hindi-English mixed sentences, pausing 1 to 2 seconds between them | rows appear in the language spoken rather than forced English; record script choice, misheard words, delay, and any wrong language detection. This is a quality measurement, not a claim that every code-switched segment will be perfect. |
